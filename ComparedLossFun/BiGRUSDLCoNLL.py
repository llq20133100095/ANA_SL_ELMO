...
from ANASLELMO_in_Conll.customLayers import Input_keywords_DotLayer, concat_attention_layer3_1, concat_attention_layer3_2, concat_attention_layer3_3
...
if __name__ == "__main__":
    ...
    # center_loss_value, new_centers = center_loss(prediction, target_var, model.alpha, centers)
