...
from ANASLELMO_in_Conll.customLoss import Stimulation_loss
from ComparedLossFun.CenterLoss import sdl
...
class Network:
    ...
    def bulit_gru(self, input_var=None, mask_var=None):
        ...
        return l_out_margin, l_in, l_mask, l_merge, l_merge_fc
...
if __name__ == "__main__":
    ...
    if model.network_type == "pi":
        ...
        train_fn = theano.function([input_var, target_var, mask_var, learning_rate_var, adam_beta1_var, negative_loss_alpha, negative_loss_lamda, input_root, input_e1, input_e2], [loss, train_acc, l_split, prediction_batch], updates=updates, on_unused_input='warn')
    ...
    att1["Content-Disposition"] = 'attachment; filename="train and test accuracy.png"'
    msg.attach(att1)
    ...
    att1["Content-Type"] = 'application/octet-stream'
    # filename in email display
    att1["Content-Disposition"] = 'attachment; filename="f1-score.png"'
    msg.attach(att1)
    try:
