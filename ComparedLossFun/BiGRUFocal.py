...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 29 20:23:17 2018
...
#    test_loss=lasagne.objectives.categorical_crossentropy(test_prediction, target_var)
    test_loss,_,_,_ = focal_loss(test_prediction,target_var)
    ...
    if model.network_type=="pi":
        ...
        train_fn = theano.function([input_var, target_var, mask_var, learning_rate_var, adam_beta1_var, negative_loss_alpha, negative_loss_lamda], [loss,train_acc,l_gru,l_split,st_loss], updates=updates, on_unused_input='warn')
        ...
        #Tempens model:run batch
            ...
            for batch in pro_data.iterate_minibatches(training_word_pos_vec3D, \
              training_label_1hot, training_sen_length, model.batch_size, shuffle=True):
                ...
                aa_mark_input=model.mask(mask_sen_length,model.batch_size)
                err ,acc, aa_l_gru,aa_l_split, st_loss = train_fn(aa_inputs, targets, aa_mark_input, learning_rate, adam_beta1, model.negative_loss_alpha, model.negative_loss_lamda)
                train_err+=err
                train_acc+=acc
                train_batches += 1
...
#        test_predicted_classid=np.array(test_predicted_classi_all[1:])
        ...
        if(epoch%50==0 and epoch!=0):
            ...
            model.save_plt(num_epochs,stimulative_listplt,'ce_loss',"Ce_loss","loss",save_path="../result/ce_loss.jpg",showflag=False)
