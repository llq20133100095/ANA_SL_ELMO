...
class Network:
    ...
    def __init__(self):
        ...
        self.save_picAllAcc_path = "../result/test_all_accuracy.jpg"
        self.save_picAllRec_path = "../result/test_all_recall.jpg"
        # save train loss picture path
        self.save_lossTrain_path = "../result/train_loss.jpg"
        # save test loss picture path
        self.save_lossTest_path = "../result/test_loss.jpg"
        # save result file
