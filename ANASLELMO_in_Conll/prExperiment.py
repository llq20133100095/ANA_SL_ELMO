...
# 1.CNN_KBP
cnn_kbp_file = '../result/experiment_PR/ANA-SL-ElAtBiGRU_conll04_glove.npz'
...
"""
# plot
save_path = "../result/experiment_PR/PR_in_KBP.jpg"
...
# plt.plot(recall["ana_sl_elatbigru2"], precision["ana_sl_elatbigru2"] - 0.01, '>-', label="ANA-SL-ElAtBiGRU (GloVe)",
#          linewidth='3')
