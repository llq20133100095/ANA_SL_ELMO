...
3 mutual learning+KAS+stimulation loss(exp()*log(1+exp(-y^+)+exp(y^-)))
...
if __name__=="__main__":
    ...
    gru_network3,_,_,_,_=model.bulit_gru(input_var,mask_var,input_root,input_e1,input_e2)
...
#    loss = Negative_loss(prediction, target_var, negative_loss_alpha, negative_loss_lamda)
    ...
    loss3,_,_, st_loss3 = SSL_Mutual2(prediction3, target_var)
...
#        loss=loss+pi_loss
    ...
    #KL-LOSS
    l_mul=unsup_weight_var*kl_loss_compute2(prediction,prediction2,prediction3)
    loss=loss+l_mul
    l_mul2=unsup_weight_var*kl_loss_compute2(prediction2,prediction,prediction3)
    loss2=loss2+l_mul2
    l_mul3=unsup_weight_var*kl_loss_compute2(prediction3,prediction,prediction2)
    loss3=loss3+l_mul3
...
#    test_loss=lasagne.objectives.categorical_crossentropy(test_prediction, target_var)
    ...
    test_loss3,_,_,_ = SSL_Mutual2(test_prediction3,target_var)
    ...
    if model.network_type=="pi":
        ...
        train_fn3 = theano.function([input_var, target_var, mask_var, learning_rate_var, adam_beta1_var, negative_loss_alpha, negative_loss_lamda, input_root, input_e1, input_e2, unsup_weight_var], [loss3,train_acc3,l_mul3,st_loss3], updates=updates3, on_unused_input='warn')
    ...
    val_fn3 = theano.function([input_var, target_var, mask_var, negative_loss_alpha, negative_loss_lamda, input_root, input_e1, input_e2], [test_loss3, test_acc3, test_predicted_classid3], on_unused_input='warn')
    ...
    for epoch in range(model.num_epochs):
        ...
        #Tempens model:run batch
            ...
            for batch in pro_data.iterate_minibatches_inputAttRootE1E2(training_word_pos_vec3D, \
              training_label_1hot, training_sen_length, model.batch_size, train_root_embedding, train_e1_embedding, train_e2_embedding, shuffle=True):
                ...
                err3 ,acc3, mul3, st_loss3 = train_fn3(aa_inputs, targets, aa_mark_input, learning_rate, adam_beta1, model.negative_loss_alpha, model.negative_loss_lamda, input_root, input_e1, input_e2, unsup_weight)                
        ...
        test_predicted_classi_all3=np.array([0])
        for batch in pro_data.iterate_minibatches_inputAttRootE1E2(testing_word_pos_vec3D, \
          testing_label_1hot, testing_sen_length, model.batch_size, test_root_embedding, test_e1_embedding, test_e2_embedding, shuffle=False):
            ...
            err3, acc3, test_predicted_classid3 = val_fn3(inputs, targets, mark_input, model.negative_loss_alpha, model.negative_loss_lamda, input_root, input_e1, input_e2)
            ...
            test_predicted_classi_all3=np.concatenate((test_predicted_classi_all3,test_predicted_classid3))
        ...
        test_predicted_classid3=np.array(test_predicted_classi_all3[1:-83])
...
#        err, acc, test_predicted_classid,_=val_fn(testing_word_pos_vec3D, testing_label_1hot, mark_input, model.negative_loss_alpha, model.negative_loss_lamda, test_root_embedding, test_e1_embedding, test_e2_embedding)
        ...
        test_con_mat=confusion_matrix(testing_label[:-83],test_predicted_classid3)
        #support
        _,_,_,support=precision_recall_fscore_support(testing_label[:-83],test_predicted_classid3)   
        #computer F1_Score
        test_f1_score3,test_accuracy3,test_recall3=model.accuracy_f1(test_con_mat,support)
        ...
        if(f1_score_max3<test_f1_score3):
            f1_score_max3=test_f1_score3
        ...
        print("  max  f1 score3:\t\t{:.2f} %".format(f1_score_max3*100))
        ...
        email_content=email_content+"  max  f1 score3:\t\t{:.2f} %".format(f1_score_max3*100)+"\n"
...
#                learning_rate=learning_rate/2.0
        ...
        if(epoch%10==0 and epoch!=0):
            ...
            model.save_plt(num_epochs,l_mul3_listplt,'kl3',"KL3","loss",save_path="../result/kl3.jpg",showflag=False)
            ...
            model.save_plt(num_epochs,stimulative3_listplt,'stimulation3',"Stimulation3","loss",save_path="../result/Stimulation3.jpg",showflag=False)
...
#    ture_pre_save_txt.close()
    ...
    np.savez('../model/model_mutual3.npz', *lasagne.layers.get_all_param_values(gru_network3))
