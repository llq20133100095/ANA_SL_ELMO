...
# -*- coding: utf-8 -*-
"""
Created on Mon May 21 17:12:09 2018

KAS+stimulation loss(stimulation loss*CE)
...
from CustomLoss import Margin_loss,Stimulation_loss
...
#    test_loss=lasagne.objectives.categorical_crossentropy(test_prediction, target_var)
    ...
    if model.network_type=="pi":
        ...
        train_fn = theano.function([input_var, target_var, mask_var, learning_rate_var, adam_beta1_var, negative_loss_alpha, negative_loss_lamda, input_root, input_e1, input_e2], [loss,train_acc,l_gru,l_split,wrong_pre,true_pre], updates=updates, on_unused_input='warn')
        ...
        #Tempens model:run batch
            ...
            for batch in pro_data.iterate_minibatches_inputAttRootE1E2(training_word_pos_vec3D, \
              training_label_1hot, training_sen_length, model.batch_size, train_root_embedding, train_e1_embedding, train_e2_embedding, shuffle=True):
                ...
                aa_mark_input=model.mask(mask_sen_length,model.batch_size)
#                if(epoch<50):
                err ,acc, aa_l_gru,aa_l_split,wrong_pre,true_pre = train_fn(aa_inputs, targets, aa_mark_input, learning_rate, adam_beta1, model.negative_loss_alpha, model.negative_loss_lamda, input_root, input_e1, input_e2)                
#                else:
