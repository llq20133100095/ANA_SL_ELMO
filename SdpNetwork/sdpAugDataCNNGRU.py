...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 31 15:11:26 2018

Augmentation Data+SDP CNN_GRU
@author: llq
"""
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 21 11:41:41 2018
...
from CustomLayers import SplitInLeft,SplitInRight,SplitInGlobal,HighwayNetwork1D,HighwayNetwork2D
...
class Network:
    ...
    def bulit_gru(self,input_var=None,mask_var=None, left_sdp_length=None, sen_length=None):
        ...
        0.CNN
        """
        l_reshape_in=lasagne.layers.ReshapeLayer(l_in,([0],1,[1],[2]))
        
        l_cnn=lasagne.layers.Conv2DLayer(
            l_reshape_in, num_filters=200, filter_size=(2, self.cnn_gru_size),
            nonlinearity=lasagne.nonlinearities.rectify,
            W=lasagne.init.GlorotUniform())
        
        l_max_pooling=lasagne.layers.ReshapeLayer(\
            lasagne.layers.GlobalPoolLayer(l_cnn, pool_function=T.max),
            ([0],[1],1))
        '''
        """
        1.Split third input.
        ...
        l_out = lasagne.layers.DenseLayer(\
            lasagne.layers.dropout(l_con_sdp_den, p=self.keep_prob_cnn_gur_output), \
        ...
        l_out = lasagne.layers.DenseLayer(\
            lasagne.layers.dropout(l_highway_network, p=self.keep_prob_cnn_gur_output),\
            num_units=self.num_classes,\
            nonlinearity=lasagne.nonlinearities.softmax)
        '''
        return l_out,l_in,l_mask,l_global_sdp_cnn,l_split_global_sdp
