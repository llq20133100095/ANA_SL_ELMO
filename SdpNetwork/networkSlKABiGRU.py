...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 22 13:46:47 2018

SSL+keywords-attention
...
from piGRU.DotSofTraLayers import SelfAttEntRootLayer,SelfAttEntRootLayer2,SelfAttEntRootLayer3
...
#            nonlinearity=lasagne.nonlinearities.selu)
        ...
        w_classes_init=np.sqrt(6.0/(19+50))
...
#    test_loss=lasagne.objectives.categorical_crossentropy(test_prediction, target_var)
    ...
    if model.network_type=="pi":
        ...
        train_fn = theano.function([input_var, target_var, mask_var, learning_rate_var, adam_beta1_var, negative_loss_alpha, negative_loss_lamda, input_root, input_e1, input_e2], [loss,train_acc,l_gru,l_split], updates=updates, on_unused_input='warn')
