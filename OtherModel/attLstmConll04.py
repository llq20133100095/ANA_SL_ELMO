...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 20 20:16:02 2018
...
from OtherModel.dotSofTraLayers import AttentionLayer
...
class Network:
    ...
    def __init__(self):
        ...
        self.keep_prob_gru_output = 0.6  # use in gru
        ...
        self.save_picAcc_path = "../result/Att-BLSTM/train-test-accuracy.jpg"
        # save F1 picture path
        self.save_picF1_path = "../result/Att-BLSTM/f1.jpg"
        self.save_picAllAcc_path = "../result/Att-BLSTM/test all accuracy.jpg"
        self.save_picAllRec_path = "../result/Att-BLSTM/test all recall.jpg"
        # save train loss picture path
        self.save_lossTrain_path = "../result/Att-BLSTM/train-loss.jpg"
        # save test loss picture path
        self.save_lossTest_path = "../result/Att-BLSTM/test-loss.jpg"
        # save result file
        self.save_result = "../result/Att-BLSTM/result.txt"
        ...
        """ PR-data """
        self.pr_data = '../result/experiment_PR/ATTBLSTM_conll04.npz'
    ...
    def bulit_gru(self, input_var=None, mask_var=None):
        ...
        l_lstm_forward = lasagne.layers.LSTMLayer(
            ...
            learn_init=True, only_return_final=False, name="l_lstm_forward2")
        ...
        l_lstm_backward = lasagne.layers.LSTMLayer(
            ...
            ingate=self.gate_parameters, forgetgate=self.gate_parameters,
            cell=self.cell_parameters, outgate=self.gate_parameters,
            learn_init=True, only_return_final=False, backwards=True, name="l_lstm_backward2")
        ...
        l_att = AttentionLayer(l_merge)

        # output dropout
        l_merge_drop = lasagne.layers.DropoutLayer(l_att, p=self.keep_prob_gru_output)
