...
# -*- coding: utf-8 -*-
"""
Created on Thu May 16 15:22:14 2019
...
#    epoch_att=T.iscalar("epoch_att")
    ...
    mask_train_input=elmo_kbp.mask_train_input(training_label,num_labels=model.num_labels)
...
#        loss=loss+pi_loss
    ...
    for epoch in range(model.num_epochs):
        ...
        #Pi model:run batch
        if model.network_type=="pi":
            for batch in elmo_kbp.iterate_minibatches_pi(training_word_pos_vec3D, \
        ...
        #Tempens model:run batch
            for batch in elmo_kbp.iterate_minibatches_tempens(training_word_pos_vec3D, \
