...
# -*- coding: utf-8 -*-
"""
Created on Fri May 17 18:12:37 2019
...
class Network:
    ...
    def __init__(self):
        ...
        #input shape
        self.input_shape=(None,82,300) #300
        #mask shape
        ...
        """Self Attention"""
        self.input_shape_att = (None,300) #1364
...
#        loss=loss+pi_loss
    ...
    for epoch in range(model.num_epochs):
        ...
        for split_n in range(elmo_kbp.train_split_n):
            ...
            training_word_pos_vec3D = np.float32(data['word_vec3D'])[:, :, :300]
            training_sen_length = data['sen_length']
            training_label_1hot = data['label_1hot']
            train_root_embedding = data['root_embedding'][:, :300]
            train_e1_embedding = data['e1_embedding'][:, :300]
            train_e2_embedding = data['e2_embedding'][:, :300]
        ...
        for split_n in range(elmo_kbp.test_split_n):
            ...
            data = np.load(train_data_file)
            testing_word_pos_vec3D = np.float32(data['word_vec3D'])[:, :, :300]
            testing_sen_length = data['sen_length']
            testing_label_1hot = data['label_1hot']
            test_root_embedding = data['root_embedding'][:, :300]
            test_e1_embedding = data['e1_embedding'][:, :300]
            test_e2_embedding = data['e2_embedding'][:, :300]
            ...
            for batch in elmo_kbp.iterate_minibatches_inputAttRootE1E2(testing_word_pos_vec3D, \
              testing_label_1hot, testing_sen_length, model.batch_size, test_root_embedding, test_e1_embedding, test_e2_embedding, shuffle=False):
                ...
                err, acc, test_predicted_classid, test_prediction = val_fn(inputs, targets, mark_input, model.negative_loss_alpha, model.negative_loss_lamda, input_root, input_e1, input_e2)
